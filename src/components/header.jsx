    ...
    return (
        <header>
            <div className='topPad'>
                ...
                <span>
                    <FontAwesomeIcon icon={faPhone} /> +91-6386241635
                </span>
                <span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav d-flex align-items-center justify-content-end me-auto mb-2 mb-lg-0 w-100 text-end">
                            ...
                            <li class="nav-item px-2 dropdown">
                                <a class="nav-a text-dark dropdown-toggle" href="/service" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Our Services
                                </a>
                                
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-a text-dark" href="/blog">Blog</a>
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-a text-dark" href="/contact">Contact Us</a>
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-a text-dark" href="/about">About Us</a>
                            </li>
